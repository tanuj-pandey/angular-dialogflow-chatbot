...
let ChatComponent = class ChatComponent {
    constructor(dialogflowService, audioRecordingService, accessTokenService) {
...
let WithBreadcrumbDashboardComponent = class WithBreadcrumbDashboardComponent {
};
...
let HoldableDirective = class HoldableDirective {
    constructor() {
    ...
    onHold() {
        this.start.emit();
        const ms = 100;
        Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["interval"])(ms).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["takeUntil"])(this.stop$), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(v => {
...
let AccessTokenSerivce = class AccessTokenSerivce {
    ...
    generateJWT() {
        ...
        let signature = btoa(js_sha256__WEBPACK_IMPORTED_MODULE_2__["sha256"].hmac(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].DF_PUBLIC_KEY, plainSignature));
        return plainSignature + '.' + signature;
    }
};
AccessTokenSerivce.ctorParameters = () => [
...
let AudioRecordingService = class AudioRecordingService {
    constructor() {
    ...
    record() {
        ...
        this.interval = setInterval(() => {
            ...
            const diffTime = moment__WEBPACK_IMPORTED_MODULE_1__["duration"](currentTime.diff(this.startTime));
...
let DialogflowService = class DialogflowService {
    ...
    detectIntent(sessionId, mesaage) {
        const payload = {
            query_input: {
                text: {
                    text: mesaage,
    ...
    detectIntentFromAudio(sessionId, audio) {
        const payload = {
            queryInput: {
                audioConfig: {
                    languageCode: "de"
    ...
    sendMessageAndGetResponse(sessionId, message) {
        return __awaiter(this, void 0, void 0, function* () {
            const responses = yield this.sessionClient.detectIntent({
...
DialogflowService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"] }
];
